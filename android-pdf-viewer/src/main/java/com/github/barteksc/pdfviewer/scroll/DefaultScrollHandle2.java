...
public class DefaultScrollHandle2 extends RelativeLayout implements ScrollHandle {
    ...
    public DefaultScrollHandle2(Context context) {
        this(context, false);
    }

    public DefaultScrollHandle2(Context context, boolean inverted) {
        super(context);
...
*/
        View layoutView = View.inflate(context ,R.layout.bottom_operator_layout , null) ;
